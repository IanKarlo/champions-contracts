...
CREATE TABLE EMAILS(
  ID NUMBER(4) CONSTRAINT NN_ID NOT NULL,
...
CREATE TABLE JOGADOR(
  ...
  RANK NUMBER(3) DEFAULT 1 CONSTRAINT NN_RANK NOT NULL,
...
CREATE TABLE PERSONAGEM(
  ...
  HP NUMBER(4) DEFAULT 1 CONSTRAINT NN_HP NOT NULL,
  ATAQUE NUMBER(4) DEFAULT 1 CONSTRAINT NN_ATAQUE NOT NULL,
  PODER NUMBER(4) DEFAULT 1 CONSTRAINT NN_PODER NOT NULL,
  ARMADURA NUMBER(4) DEFAULT 1 CONSTRAINT NN_ARMADURA NOT NULL,
  V_ATAQUE NUMBER(4) DEFAULT 1 CONSTRAINT NN_V_ATAQUE NOT NULL,
  V_MOVIMENTO NUMBER(4) DEFAULT 1 CONSTRAINT NN_V_MOVIMENTO NOT NULL
);

CREATE TABLE OFENSIVO(
  NOME VARCHAR2(50) CONSTRAINT PK_OFENSIVO PRIMARY KEY,
  CRITICO NUMBER(4) DEFAULT 1 CONSTRAINT NN_CRITIC NOT NULL,
...
CREATE TABLE DEFENSIVO(
  NOME VARCHAR2(50) CONSTRAINT PK_DEFENSIVO PRIMARY KEY,
  RESISTENCIA NUMBER(4) DEFAULT 1 CONSTRAINT NN_RESISTENCIA NOT NULL,
  CONSTRAINT FK_DEFENSIVO_PERSONAGEM_NOME FOREIGN KEY (NOME)
    REFERENCES PERSONAGEM (NOME) ON DELETE CASCADE
);

CREATE TABLE SUPORTE(
  NOME VARCHAR2(50) CONSTRAINT PK_SUPORTE PRIMARY KEY,
  CURA NUMBER(4) DEFAULT 1 CONSTRAINT NN_CURA NOT NULL,
...
CREATE TABLE PARCERIA(
  ...
  MITIGACAO NUMBER(4) DEFAULT 1 CONSTRAINT NN_MITIGACAO NOT NULL,
...
CREATE TABLE PROTEGE(
  ...
  EXALTACAO NUMBER(4) DEFAULT 1 CONSTRAINT  NN_PROTEGE NOT NULL,
...
CREATE TABLE ITEM(
  NOME VARCHAR2(50) CONSTRAINT PK_ITEM PRIMARY KEY,
...
CREATE TABLE PARTIDA(
  CODIGO VARCHAR2(10) CONSTRAINT PK_PARTIDA PRIMARY KEY,
  INICIO_PARTIDA TIMESTAMP NOT NULL,
  MAPA VARCHAR2(20) NOT NULL,
  DURACAO NUMBER(3),
  TIME_V CHAR(1),
  CONSTRAINT CHK_MAPA CHECK (MAPA IN ('Rift', 'Inferno', 'Dust', 'Icebox')),
  CONSTRAINT CHK_TIME_V CHECK (TIME_V IN ('R','B'))
);
...
CREATE TABLE PARTICIPA(
  ...
  CODIGO VARCHAR2(10),
  TIME CHAR(1),
  KILL NUMBER(4) DEFAULT 0,
  DEATH NUMBER(4) DEFAULT 0,
  ASSIST NUMBER(4) DEFAULT 0,
  ...
  CONSTRAINT DEATH CHECK (DEATH >= 0),
  CONSTRAINT KILL CHECK (KILL >= 0),
  CONSTRAINT ASSIST CHECK (ASSIST >= 0)
);